...
First task aims to visualize the position obtained from accelaration information. Then, it will be checked whether they are consistent with the defined class shape or not. According to the 3D scatter plots below, shapes are consistent with the defined classes.
...
##Visualization of two time series in class 1
...
##Visualization of two time series in class 2
...
##Visualization of two time series in class 3
...
##Visualization of two time series in class 4
...
##Visualization of two time series in class 5
...
##Visualization of two time series in class 6
...
##Visualization of two time series in class 7
...
##Visualization of two time series in class 8
...
In task 3, the data is splitted according to class information and principal component analysis is applied for each class separately. According to results, proportion of the variance explained by the fist component has increased.
